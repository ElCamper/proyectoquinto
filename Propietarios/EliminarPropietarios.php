...
<head>
    ...
    <title>Eliminación de propietario</title>
            ...
            <li class="nav-item active">
                ...
                <div id="propietario" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Eliminación de <br> propietarios</a>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Eliminación de propietario</h1>
                                            </div>
                                            ...
                                            <form>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="date" class="form-control form-control-user" disabled id="nacimiento"
                                                            placeholder="Fecha de nacimiento">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" disabled id="nombre1"
                                                            placeholder="Primer nombre">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" disabled id="nombre2"
                                                            placeholder="Segundo nombre">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" disabled id="apellido1"
                                                            placeholder="Primer apellido">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" disabled id="apellido2"
                                                            placeholder="Segundo apellido">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" disabled id="telefono"
                                                        placeholder="Telefono">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="email" class="form-control form-control-user" disabled id="correo"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                                                        <a href="#" class="btn btn-success btn-icon-split w-50" data-target="#advertencia" data-toggle="modal">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-check"></i>
                                                            </span>
                                                            <span class="text w-100">Eliminar propietario</span>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="advertencia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">Selecione "Continuar" si realmente desea eliminar a este propietario.</div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-danger" type="button" data-dismiss="modal">Cancelar</button>
                                                                <a id="submit" class="btn btn-secondary" data-dismiss="modal">Continuar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
