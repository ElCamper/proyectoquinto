...
<head>
    ...
    <title>Actualización de propietarios</title>
            ...
            <li class="nav-item active">
                ...
                <div id="propietario" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="RegistrarPropietarios.php">Registro de propietarios</a>
                        <a class="collapse-item active" href="#">Actualización de <br> propietarios</a>
                        ...
                        <div class="card o-hidden border-0 shadow-lg my-5">
                            <div class="card-body p-0">
                                ...
                                <div class="row">                                 
                                    <div class="col-lg-8">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Actualización de datos de propietarios</h1>
                                            </div>
                                            ...
                                            <form>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" disabled id="cedula"
                                                            placeholder="Cedula de identidad">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="date" class="form-control form-control-user" id="nacimiento" required max="<?php echo date('Y-m-d'); ?>"
                                                            placeholder="Fecha de nacimiento">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" id="nombre1" required onkeypress="return ValidarSoloTexto(event)" minlength="2" maxlength="25" required
                                                            placeholder="Primer nombre">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" id="nombre2" required onkeypress="return ValidarSoloTexto(event)" minlength="2" maxlength="25" required
                                                            placeholder="Segundo nombre">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" id="apellido1" required onkeypress="return ValidarSoloTexto(event)" minlength="2" maxlength="25" required
                                                            placeholder="Primer apellido">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" id="apellido2" required onkeypress="return ValidarSoloTexto(event)" minlength="2" maxlength="25" required
                                                            placeholder="Segundo apellido">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" id="telefono" required onkeypress="return ValidarSoloNumero(event)" minlength="10" maxlength="10" required
                                                        placeholder="Telefono">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="email" class="form-control form-control-user" id="correo" required pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,4}" maxlength="70" required
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                                                        <a href="#" class="btn btn-success btn-icon-split w-50">
                                                            ...
                                                            <span class="text w-100">Actualizar datos del propietario</span>
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-4"  style="background-image: url('https://preferredbynature.org/sites/default/files/inline-images/Indonesia%20Rice%20project.jpg'); background-position: center; background-size: cover;">
