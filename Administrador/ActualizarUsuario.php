    ...
    if($_POST){
        if($_POST["idPOST"]){
            ...
            if($row > 0){
                ...
                <script>
                    function mensaje(){
                        ...
                        document.getElementById("cargo").value = "'.$cargo1.'";
                        document.getElementById("correo").value = "'.$correo1.'";
                    }
                </script>';
            }else{
                $sql = "UPDATE usuario SET nombre = '$nombre1', apelllido = '$apellido1', cargo = '$cargo1', telefono = '$telefono1', correo = '$correo1', contraseña = '$contrase' WHERE ID = '$idPOST'";
                ...
                if($conn->query($sql) === true){
                    ...
                    <script>
                        function mensaje(){
                            document.getElementById("alertasMensajes").style.display = "block";
                            document.getElementById("alertasMensajes").innerHTML = "Se actualizaron los datos del usuario con exito";
                            document.getElementById("alertasMensajes").style.backgroundColor = "lightgreen";
                            document.getElementById("alertasMensajes").style.color = "black";
                        }
                    </script>';
                    ...
                    <script>
                        function mensaje(){
                            document.getElementById("alertasMensajes").style.display = "block";
                            document.getElementById("alertasMensajes").innerHTML = "Hubo un error, no se ha podido realizar la actualización";
                            document.getElementById("alertasMensajes").style.backgroundColor = "#dc143c";
                            document.getElementById("alertasMensajes").style.color = "white";
                        }
                    </script>';
            ...
            <script>
                function mensaje(){
                    document.getElementById("alertasMensajes").style.display = "block";
                    document.getElementById("alertasMensajes").innerHTML = "Hubo un error, debe ingresar un ID para realizar la actualización";
                    document.getElementById("alertasMensajes").style.backgroundColor = "#dc143c";
                    document.getElementById("alertasMensajes").style.color = "white";
                }
            </script>';
            ...
            <li class="nav-item active">
                ...
                <div id="admin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Actualización de usuario</a>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Actualización de datos de usuario</h1>
                                            </div>
                                            <form method="GET" action="ActualizarUsuario.php" class="user navbar-search" autocomplete="off">
                                                <div class="input-group">
                                            ...
                                            <hr>
                                            <form method="POST" action="ActualizarUsuario.php" autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-user" name="nombre" id="nombre" onkeypress="return ValidarSoloTexto(event)" minlength="2" maxlength="20" required
                                                            placeholder="Nombre" disabled value="<?php echo @$nombre; ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <select name="cargo" disabled id="cargo" class="form-control form-control-user" aria-label="cargo" required>
                                                            <option value="" selected disabled hidden>Seleccionar cargo</option>
                                                            <option id="cargoAnterior" disabled value="<?php echo  "Anterior".@$cargo; ?>">La opción anterior fue (<?php echo @$cargo; ?>)</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="password" class="form-control form-control-user" name="contraseña" onkeypress="return ValidarContra(event)" minlength="8" maxlength="20" required
                                                            id="contraseña" placeholder="Contraseña" disabled value="<?php echo @$contraseña; ?>">
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="form-group row">
                                                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                                                        <button type="submit" class="btn btn-success btn-icon-split w-50">
                                                            ...
                                                            <span class="text w-100">Actualizar datos del usuario</span>
                                                    </div>
                                                </div>
