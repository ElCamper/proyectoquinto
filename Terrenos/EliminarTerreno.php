...
<head>
    ...
    <title>Eliminación de terrenos agrícolas</title>
            ...
            <li class="nav-item active">
                ...
                <div id="terrenos" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Eliminación de terrenos <br> registrados</a>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Eliminación de terreno agrícola</h1>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" disabled id="cultivo"
                                                        placeholder="Cultivo">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" disabled id="hectarea"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                                                        <a href="#" class="btn btn-success btn-icon-split w-50" data-target="#advertencia" data-toggle="modal">
                                                            ...
                                                            <span class="text w-100">Eliminar terreno agrícola</span>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="advertencia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">Selecione "Continuar" si realmente desea eliminar a este terreno agrícola. Esta acción no se puede deshacer.</div>
